export interface Project {
  ...
  title: string;
  description: string;
  image: string; // Consider using local images for better performance and stability
  tags: string[];
  githubUrl: string;
  liveUrl?: string;
  featured: boolean;
...
export const projects: Project[] = [{
  ...
  githubUrl: "https://github.com/Chams-sat/e-commerce-platform", // Example URL
  featured: false
}, {
  id: 3,
  ...
  githubUrl: "https://github.com/Chams-sat/task-management-app", // Example URL
  featured: false
}, {
  id: 4,
  ...
  githubUrl: "https://github.com/Chams-sat/Weather-app",
  ...
  githubUrl: "https://github.com/Chams-sat/Todo-app",
  ...
  githubUrl: "https://github.com/Chams-sat/Little-Sprouts",
  ...
  image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=500",
  tags: ["Vanilla JavaScript", "CSS", "HTML", "Tailwind CSS"],
  githubUrl: "https://github.com/Chams-sat/Plant-Dashboard",
